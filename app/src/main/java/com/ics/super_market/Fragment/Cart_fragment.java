...
import com.ics.super_market.Adapter.Cart_adapter;
...
import com.ics.super_market.LoginActivity;
...
public class Cart_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.ics.super_market.MainActivity) getActivity()).setTitle(getResources().getString(R.string.tv_cart_title));
