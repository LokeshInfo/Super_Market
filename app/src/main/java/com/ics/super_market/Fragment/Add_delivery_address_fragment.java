...
import com.ics.super_market.Model.Delivery_address_model;
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        int locationid = job.getInt("location_id");
                        Log.e(">>>>>>>> "," lid "+locationid);
                        Bundle arggs = new Bundle();
                        arggs.putString("location_id", ""+locationid);
                        arggs.putString("pincode", job.getString("pincode"));
                        arggs.putString("house_no", job.getString("house_no"));
                        arggs.putString("receiver_name", job.getString("receiver_name"));
                        arggs.putString("receiver_mobile", job.getString("receiver_mobile"));

                        arggs.putString("house_address",job.getString("house_address"));
