...
import com.ics.super_market.Adapter.Delivery_get_address_adapter;
...
public class Delivery_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.ics.super_market.MainActivity) getActivity()).setTitle(getResources().getString(R.string.delivery));
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        //RecyclerView.com.ics.super_market.Adapter adapter1 = new Delivery_get_address_adapter(delivery_address_modelList);
