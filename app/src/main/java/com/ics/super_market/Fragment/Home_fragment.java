...
import com.ics.super_market.Adapter.DealsAdapter;
import com.ics.super_market.Adapter.Home_adapter;
import com.ics.super_market.Adapter.HorizontalAdapter;
import com.ics.super_market.Adapter.OfferAdapter;
import com.ics.super_market.Adapter.RecyclerViewHorizontalListAdapter;
import com.ics.super_market.Config.BaseURL;
import com.ics.super_market.Model.Category_model;
import com.ics.super_market.Model.Data;
import com.ics.super_market.Model.DealsModel;
import com.ics.super_market.Model.Grocery;
import com.ics.super_market.Model.OfferModel;
...
import com.ics.super_market.HttpHandler;
...
public class Home_fragment extends Fragment {
    ...
    ExpandableLayout expandable_feature;
    RelativeLayout feature_drop;
    ImageView img_drop;
    TextView tv_moreless;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.ics.super_market.MainActivity) getActivity()).set_style_Title(""+getActivity().getResources().getString(R.string.app_name));
        ((com.ics.super_market.MainActivity) getActivity()).updateHeader();
        ...
        expandable_feature =  view.findViewById(R.id.expandable_lyt1);
        feature_drop =  view.findViewById(R.id.feature_drop);
        img_drop =  view.findViewById(R.id.img_drop);
        tv_moreless =  view.findViewById(R.id.tv_moreless);
...
//        rv_items.setLayoutManager(gridLayoutManager);
        ...
        if (ConnectivityReceiver.isConnected()) {
            ...
            new GetCategoryRequest().execute();
        }
...
//*****************************************************************************************************
        ...
        feature_drop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (expandable_feature.isCollapsed()) {
                    expandable_feature.expand();
                    img_drop.setImageDrawable(getResources().getDrawable(R.drawable.ic_arrow_up));
                    tv_moreless.setText("Show Less");
                }else{
                    expandable_feature.collapse();
                    img_drop.setImageDrawable(getResources().getDrawable(R.drawable.ic_arrow_down));
                    tv_moreless.setText("Show More");
                }
            }});
...
//*****************************************************************************************************
    ...
    private void makeGetSliderRequest() {
        ...
        com.ics.super_market.AppController.getInstance().addToRequestQueue(req);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_search:
              /*  com.ics.super_market.Fragment fm = new Search_fragment();
                FragmentManager fragmentManager = getFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.contentPanel, fm)
                        .addToBackStack(null).commit();
                return false;*/
    ...
    class GetCategoryRequest extends AsyncTask<String, String, String> {
        String output = "";
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                server_url = BaseURL.GET_CATEGORY_URL;
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(String output) {
            if (output == null) {
                ...
                try {
                    ...
                    Boolean status = job.getBoolean("responce");
                    if (status) {
                        ...
                        category_modelList = gson.fromJson(jarr.toString(), listType);
        ...
        protected void onPostExecute(String output) {
            if (output == null) {
                ...
                try {
                    ...
                    offerlist.setLayoutManager(new GridLayoutManager(getActivity(), 3,GridLayoutManager.VERTICAL,false));
