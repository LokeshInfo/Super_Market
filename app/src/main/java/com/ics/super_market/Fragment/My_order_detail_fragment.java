...
import com.ics.super_market.Adapter.My_order_detail_adapter;
import com.ics.super_market.Config.BaseURL;
import com.ics.super_market.Model.My_order_detail_model;
import com.ics.super_market.R;
import com.ics.super_market.AppPreference;
import com.ics.super_market.ConnectivityReceiver;
import com.ics.super_market.CustomVolleyJsonArrayRequest;
...
public class My_order_detail_fragment extends Fragment {
    ...
    private void makeGetOrderDetailRequest(String sale_id) {
        ...
        com.ics.super_market.AppController.getInstance().addToRequestQueue(jsonObjReq, tag_json_obj);
