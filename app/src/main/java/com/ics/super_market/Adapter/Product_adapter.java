package com.ics.super_market.Adapter;
...
import com.ics.super_market.Fragment.Show_pro_detail_fragment;
import com.ics.super_market.Model.Product_model;
        ...
        public void onClick(View view) {
            ...
            if (id == R.id.iv_subcat_plus) {
                ...
                if ( modelList.get(position).getIn_stock().equals("1")) {
                    ...
                    ((com.ics.super_market.MainActivity) context).setCartCounter("" + dbcart.getCartCount());
